function navbar() {
        ...
        <div id="hovermenudiv" class="w-72 bg-blue-100 overflow-y-scroll" style="height: 100vh">
            ...
            <div id="afterlogin" class="hidden">
                ...
                <div class="grid my-auto">
                    <a href="#" id="mobuserkanaam" class="font-medium hover:text-blue-700">Micheal</a>
                    <a href="#" id="mobuseremail" class="text-sm text-gray-500">codevector@gmail.com</a>
                </div>
            </div>
            <hr>
    ...
    <div id="hoveruser" class="hidden" style="margin-left: 80%;">
        ...
        <div class="flex gap-2 m-4">
            ...
            <div class="grid my-auto">
                <a href="#" id="username" class="font-medium hover:text-blue-700">Micheal</a>
                <a href="#" id="useremail" class="text-sm text-gray-500">code.vector@gmail.com</a>
            </div>
        </div>
        <hr>
        <!-- others -->
        ...
        <div class="m-4 text-sm text-gray-600 hover:text-blue-700"><a href="#">Teach on CodeVector</a></div>
        <hr>
        ...
        <div class="m-4 text-sm text-gray-600 hover:text-blue-700"><a href="#">CodeVector credits</a></div>
